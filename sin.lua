...
script.Name = math.random(100, 100000)
...
wait()
chatfunc("sin only gets stronger when it dies")
wait()
...
local function yes()
wait()
LeftArmHandle.Transparency = 1
LeftLegHandle.Transparency = 1
RightArmHandle.Transparency = 1
RightLegHandle.Transparency = 1
TorsoHandle.Transparency = 1
...
wait()
chatfunc("nice try killing me")
end -- end of death function
